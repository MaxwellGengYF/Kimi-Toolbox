...
Each `path` may also be a glob pattern such as `./*.md` to read all matching files in a directory. The total number of files read in one call cannot exceed ${MAX_FILES}.
