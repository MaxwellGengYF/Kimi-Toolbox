"""Pascal/Delphi comment parser ({ ... } and (* ... *) block, // line comments).
...
_CompatParser = _compat.PascalParser


class PascalParser(_CompatParser):
    """Parse Pascal source code and extract comments."""
