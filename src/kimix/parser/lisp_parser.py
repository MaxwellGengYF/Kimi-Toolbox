"""Lisp/Scheme/Clojure comment parser (; line and #| ... |# block comments).
...
_CompatParser = _compat.LispParser


class LispParser(_CompatParser):
    """Parse Lisp source code and extract comments."""
